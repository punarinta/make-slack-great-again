...
QString resolveEmoji(const QString &name) {
    static const QHash<QString,QString> kTable = {
        ...
        {"heart","❤️"},{"hearts","❤️"},{"fire","🔥"},{"100","💯"},
        {"smile","😊"},{"slightly_smiling_face","🙂"},{"blush","😊"},
        {"joy","😂"},{"laughing","😆"},{"sweat_smile","😅"},{"sob","😭"},
        {"thinking_face","🤔"},{"sunglasses","😎"},{"zany_face","🤪"},
        {"exploding_head","🤯"},{"face_palm","🤦"},{"shrug","🤷"},
        {"tada","🎉"},{"wave","👋"},{"eyes","👀"},{"rocket","🚀"},
        {"pray","🙏"},{"clap","👏"},{"raised_hands","🙌"},{"ok_hand","👌"},
        {"point_right","👉"},{"point_left","👈"},
        {"white_check_mark","✅"},{"x","❌"},{"question","❓"},
        {"heavy_exclamation_mark","❗"},{"star","⭐"},{"sparkles","✨"},
        {"boom","💥"},{"skull","💀"},{"poop","💩"},{"zzz","💤"},
        {"muscle","💪"},{"raised_hand","✋"},{"v","✌️"},
        {"warning","⚠️"},{"speech_balloon","💬"},{"memo","📝"},
        {"calendar","📅"},{"clock1","🕐"},{"hourglass","⌛"},
        {"key","🔑"},{"lock","🔒"},{"unlock","🔓"},{"link","🔗"},
        {"mag","🔍"},{"pencil","✏️"},{"wrench","🔧"},{"hammer","🔨"},
        {"bulb","💡"},{"loudspeaker","📢"},{"bell","🔔"},{"no_bell","🔕"},
        {"mailbox","📫"},{"email","📧"},{"computer","💻"},{"iphone","📱"},
        {"chart_with_upwards_trend","📈"},{"chart_with_downwards_trend","📉"},
        {"moneybag","💰"},{"dollar","💵"},{"rotating_light","🚨"},
