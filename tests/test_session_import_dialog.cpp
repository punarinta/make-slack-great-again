...
// state a machine without local-import support shows: guided manual fields
// revealed) to a PNG so the layout can be eyeballed, and asserts the card grew
// to fit its content (regression guard for the clipped/overlapping-steps bug).
